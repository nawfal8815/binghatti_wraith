...
export default function App() {
  ...
  return (
    <div className="bg-black text-white font-sans selection:bg-white selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <button 
              ...
              className="px-6 py-2.5 bg-white text-black text-[11px] uppercase tracking-widest font-bold rounded-full hover:bg-gray-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]"
            >
              Register Interest
            </button>
          </div>
            ...
            <div className="flex flex-col gap-8 mt-12">
              {["Overview", "Collections", "Amenities", "Location"].map((item) => (
                <button 
                  ...
                  className="text-2xl font-extralight uppercase tracking-widest text-left"
                >
                  {item}
                </button>
              ))}
              <button 
                onClick={() => { scrollToSection('inquiry'); setMobileMenuOpen(false); }}
                className="text-2xl font-bold uppercase tracking-widest text-left text-white"
              >
                Register Interest
              </button>
            </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <motion.p 
            ...
            className="text-xs md:text-sm uppercase tracking-[0.5em] text-white/80 mb-6 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-8xl font-extralight tracking-tighter mb-8"
          >
            Mercedes-Benz <span className="text-white/40">Places</span>
          </motion.h1>
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <button 
              ...
              className="px-10 py-4 bg-white text-black text-xs uppercase tracking-[0.3em] font-bold rounded-full hover:scale-105 transition-transform shadow-[0_0_25px_rgba(255,255,255,0.2)]"
            >
              Experience Now
            </button>
            <div className="flex items-center gap-4 text-white/60">
              <div className="h-px w-12 bg-white/20" />
              <span className="text-[10px] uppercase tracking-widest">Binghatti City | Dubai</span>
              <div className="h-px w-12 bg-white/20" />
            </div>
          </motion.div>
        </div>
      ...
      <section id="overview" className="py-32 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <FadeIn direction="right">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden group shadow-[0_0_50px_rgba(255,255,255,0.05)]">
          ...
          <div>
            <FadeIn delay={0.2}>
              ...
              <div className="space-y-6 text-gray-400 text-lg font-light leading-relaxed">
                <p>
                  Mercedes-Benz Places | Binghatti City is a landmark residential community that redefines urban living. 
                  Not merely structures, but a masterplanned city-scale vision where global brand prestige becomes 
                  a personal, lived-in experience.
                </p>
                <p>
                  Composed of 12 towers, the city establishes an undeniable presence. Structures exercise 
                  precision engineering, where flowing, sculpted surfaces embody kinetic energy and motion.
                </p>
              </div>
            </FadeIn>
          </div>
      ...
      {/* Collections Section */}
      <section id="collections" className="py-32 bg-white/[0.02] backdrop-blur-3xl border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <SectionHeading subtitle="Project Layouts" title="The Collections" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {amenities.map((item, idx) => (
              <FadeIn key={idx} delay={idx * 0.05}>
                <div className="flex flex-col items-center gap-4 p-8 rounded-3xl border border-white/5 bg-white/[0.03] hover:bg-white/10 hover:shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all text-center group">
